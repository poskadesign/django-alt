...
from django_alt.__legacy__.django_alt.abstract.serializers import BaseValidatedSerializer
from django_alt.__legacy__.django_alt.abstract.validators import Validator
from django_alt.__legacy__.django_alt.serializers import ValidatedModelSerializer
from django_alt.__legacy__.django_alt.utils.shortcuts import invalid, invalid_if, if_in
from django_alt.__legacy__.django_alt_tests.conf.models import ModelA

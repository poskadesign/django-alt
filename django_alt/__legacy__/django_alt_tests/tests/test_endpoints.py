...
from django_alt.__legacy__.django_alt.abstract.endpoints import MetaEndpoint
from django_alt.__legacy__.django_alt.endpoints import Endpoint
from django_alt.__legacy__.django_alt_tests.conf.endpoints import ModelASerializer, ModelAEndpoint1
